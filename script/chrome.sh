...
chromeExe="/Applications/Google\ Chrome\ Dev.app/Contents/MacOS/Google\ Chrome\ Dev --incognito --remote-debugging-port=$port --user-data-dir=\"$chromeUserDir\" --disable-web-security --disable-dev-shm-usage"
